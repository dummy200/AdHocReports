...
public class SoaOrixExtController2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String page = "/pages/collections/soa orix ext2/SoaOrixExt2.jsp";
		String page2 = "/SoaOrixExtController2?action=OrixSoaExt2";
		String tranCd = "94";
		String errorMsg = "";
		/* request.getParameter("redirectPage"); */

		if (action.equals("OrixSoaExt2")) {
		...
		if (action.equals("printReport")) {
			...
			String outputXls = reportName + new SimpleDateFormat("yyyyMMdd").format(new Date()) + ".xls";
			...
			System.out.println(branch+fromDate+toDate);
			...
			try {
				...
				RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/pages/collections/soa orix ext2/hiddenDiv.jsp");
				dispatcher.forward(request, response);
			}
		}
	}
